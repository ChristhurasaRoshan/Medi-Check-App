...
public class RegisterActivity extends AppCompatActivity {
    EditText edUsername, edEmail, edConfirm, edPassword; // Added a semicolon to separate declarations
    Button btn;
    TextView tv;
    ...
    public static boolean isValid(String passwordhere) {
        ...
        if (passwordhere.length() < 8) {
            ...
            for (int r = 0; r < passwordhere.length(); r++) {
                if (Character.isDigit(passwordhere.charAt(r)) || !Character.isLetterOrDigit(passwordhere.charAt(r))) {
                    f2 = 1;
                }
            }
